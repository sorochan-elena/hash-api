...
func (x *Hash) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_internal_proto_service_proto_rawDesc = []byte{
	...
	0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x55, 0x0a, 0x04,
	...
	0x64, 0x41, 0x74, 0x32, 0x31, 0x0a, 0x07, 0x48, 0x61, 0x73, 0x68, 0x41, 0x70, 0x69, 0x12, 0x26,
	...
	0x48, 0x61, 0x73, 0x68, 0x22, 0x00, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x2f, 0x68, 0x61, 0x73, 0x68,
...
var file_internal_proto_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_internal_proto_service_proto_depIdxs = []int32{
	1, // 0: Hash.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: HashApi.Get:input_type -> google.protobuf.Empty
	0, // 2: HashApi.Get:output_type -> Hash
